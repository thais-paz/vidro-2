namespace SpriteKind {
    export const Vidro = SpriteKind.create()
}
sprites.onOverlap(SpriteKind.Player, SpriteKind.Vidro, function (sprite, otherSprite) {
...
let Lixeira_Vidro = sprites.create(img`
    ...
    7 7 7 7 7 1 1 7 1 1 7 7 7 7 7 7 
    7 7 7 7 1 1 7 7 7 1 1 7 7 7 7 7 
...
scene.setBackgroundImage(img`
    ...
    bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
    `)
controller.moveSprite(Lixeira_Vidro, 60, 60)
Lixeira_Vidro.setStayInScreen(true)
game.setDialogCursor(img`
    ...
    . . . . . f f . . f f . . . . . 
    `)
game.showLongText("Você deve ser o novo ajudante, certo? Seja bem-vindo", DialogLayout.Bottom)
game.showLongText("É muito importante a sua participação neste projeto", DialogLayout.Bottom)
game.showLongText("Sua atual tarefa é coletar o máximo de lixo do tipo VIDRO pelos próximos 20 segundos", DialogLayout.Bottom)
game.showLongText("Caso pegue lixos do tipo ORGÂNICO, PAPEL, METAL ou PLÁSTICO, deverá refazer o trabalho", DialogLayout.Bottom)
game.showLongText("Não podemos misturar os tipos de lixos na reciclagem!", DialogLayout.Bottom)
...
game.onUpdateInterval(1000, function () {
    mySprite = sprites.create(img`
        ...
        ....................
        `, SpriteKind.Vidro)
    mySprite.setPosition(randint(340, 0), randint(0, 20))
    mySprite.setVelocity(0, 27)
})
game.onUpdateInterval(1000, function () {
    mySprite = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Enemy)
    mySprite.setPosition(randint(520, 0), randint(0, 20))
    mySprite.setVelocity(0, 26)
})
